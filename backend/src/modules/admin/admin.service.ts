...
export class AdminService {
  ...
  async createStudent(dto: StudentAccountDto) {
    ...
    if (deliveryEmail !== email) {
      throw new UnprocessableEntityException('Student credential delivery email must match the email in the imported student row.');
    }
    // Passwords are always generated by the system and never revealed to administrators.
